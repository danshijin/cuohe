...
public class buycountController {
	...
	public   ModelAndView  trailQuary(HttpServletRequest req,Integer pno){
		...
		List<OrdercodeEntity> ordercountlist1=trialcountBo.querycaigoujiacounts(map);
		...
		List<OrdercodeEntity> projialist=trialcountBo.querycaigoujiacounts(map);
		...
		view.addObject("projialist", projialist);
